...
class Anchor {
	...
	public static var top(get, null): Int = 0;
	public static var bottom(get, null): Int = 0;
	public static var left(get, null): Int = 0;
	public static var right(get, null): Int = 0;
	public static var width(get, null): Int = 0;
	public static var height(get, null): Int = 0;
	public static var center_x(get, null): Int = 0;
	public static var center_y(get, null): Int = 0;
