...
abstract Profiler(NativeProfiler) {
	public static inline function load_zone() NativeProfiler.load_zone();
	public static inline function start_frame() NativeProfiler.start_frame();
	public static inline function end_frame() NativeProfiler.end_frame();
	public static inline function marker(label: String, ?color: SegmentColor, ?pos: haxe.PosInfos) NativeProfiler.marker(label, color, pos);
	public static inline function push_block(label: String, ?color: SegmentColor, ?pos: haxe.PosInfos) NativeProfiler.push_block(label, color, pos);
	public static inline function pop_block() NativeProfiler.pop_block();
}
